...
// ============================================
// ARQUITETO PRINCIPAL DE DADOS DO JOGO
// ============================================
...
public class PlayerData
{
    ...
    // ===== NOVO: EQUIPAMENTOS POR PERSONAGEM (ADICIONADO) =====
    public CharacterEquipmentData characterEquipment = new CharacterEquipmentData();
    
    // ===== NOVO: ESTATÍSTICAS DO PERSONAGEM ATIVO (ADICIONADO) =====
    public int characterCurrentHP = 15;
    public int characterCurrentMP = 10;
    public int characterMaxHP = 15;
    public int characterMaxMP = 10;
}
...
// ============================================
// DADOS DE INVENTÁRIO ORIGINAL + EXPANSÃO
// ============================================

[System.Serializable]
public class InventoryData
{
    // ===== SISTEMA ORIGINAL (MANTIDO 100%) =====
    ...
    // Equipamentos atuais (sistema antigo)
    ...
    // ===== RECURSOS PARA BARCO (MANTIDO 100%) =====
    ...
    // ===== SISTEMA DE INVENTÁRIO COMPLETO (NOVO) =====
    ...
    // Itens no inventário compartilhado
    public List<InventoryItemData> items = new List<InventoryItemData>();
    
    // Equipment loadout COMPARTILHADO
    public EquipmentLoadoutData sharedEquipmentLoadout = new EquipmentLoadoutData();
    
    // Estado das categorias da UI (opcional, para lembrar expandido/recolhido)
    public SerializableDictionary<string, bool> categoryStates = new SerializableDictionary<string, bool>();
}

// ============================================
// NOVAS ESTRUTURAS PARA INVENTÁRIO COMPLETO
// ============================================
...
public class InventoryItemData
{
    ...
    public int slotIndex = -1; // -1 significa slot automático
    ...
    public ItemData.EquipmentSlot equipmentSlot = ItemData.EquipmentSlot.None;
    public ItemData.WeaponType weaponType = ItemData.WeaponType.None;
    ...
    // Construtor para criar a partir de ItemData
    public InventoryItemData(ItemData itemData, int quantity = 1)
    {
        ...
        magicAttackBonus = itemData.magicAttackBonus;
        magicDefenseBonus = itemData.magicDefenseBonus;
        speedBonus = itemData.speedBonus;
        criticalRateBonus = itemData.criticalRateBonus;
        evasionBonus = itemData.evasionBonus;
...
{
    // IDs dos itens equipados (por slot)
    ...
    public string longRangeItemID;
    public string mainHandItemID;
    
    // Helper methods
    public string GetItemIDForSlot(ItemData.EquipmentSlot slot)
    {
        switch (slot)
        {
            case ItemData.EquipmentSlot.Weapon: return weaponItemID;
            case ItemData.EquipmentSlot.Armor: return armorItemID;
            case ItemData.EquipmentSlot.Body: return bodyItemID;
            case ItemData.EquipmentSlot.Helmet: return helmetItemID;
            case ItemData.EquipmentSlot.Gloves: return glovesItemID;
            case ItemData.EquipmentSlot.Boots: return bootsItemID;
            case ItemData.EquipmentSlot.Accessory: return accessoryItemID;
            case ItemData.EquipmentSlot.Ring: return ringItemID;
            case ItemData.EquipmentSlot.Amulet: return amuletItemID;
            case ItemData.EquipmentSlot.OffHand: return offHandItemID;
            case ItemData.EquipmentSlot.LongRange: return longRangeItemID;
            case ItemData.EquipmentSlot.MainHand: return mainHandItemID;
            default: return string.Empty;
        }
    }
    
    public void SetItemIDForSlot(ItemData.EquipmentSlot slot, string itemID)
    {
        switch (slot)
        {
            case ItemData.EquipmentSlot.Weapon: weaponItemID = itemID; break;
            case ItemData.EquipmentSlot.Armor: armorItemID = itemID; break;
            case ItemData.EquipmentSlot.Body: bodyItemID = itemID; break;
            case ItemData.EquipmentSlot.Helmet: helmetItemID = itemID; break;
            case ItemData.EquipmentSlot.Gloves: glovesItemID = itemID; break;
            case ItemData.EquipmentSlot.Boots: bootsItemID = itemID; break;
            case ItemData.EquipmentSlot.Accessory: accessoryItemID = itemID; break;
            case ItemData.EquipmentSlot.Ring: ringItemID = itemID; break;
            case ItemData.EquipmentSlot.Amulet: amuletItemID = itemID; break;
            case ItemData.EquipmentSlot.OffHand: offHandItemID = itemID; break;
            case ItemData.EquipmentSlot.LongRange: longRangeItemID = itemID; break;
            case ItemData.EquipmentSlot.MainHand: mainHandItemID = itemID; break;
        }
    }
    
    public bool HasItemInSlot(ItemData.EquipmentSlot slot)
    {
        return !string.IsNullOrEmpty(GetItemIDForSlot(slot));
    }
    
    public void ClearSlot(ItemData.EquipmentSlot slot)
    {
        SetItemIDForSlot(slot, string.Empty);
    }
}

// ============================================
// ESTRUTURAS PARA EQUIPAMENTOS POR PERSONAGEM
// ============================================

[System.Serializable]
public class CharacterEquipmentData
{
    // Equipamentos específicos por personagem
    public EquipmentLoadoutData activeCharacterLoadout = new EquipmentLoadoutData();
    
    // Dados dos personagens do party
    public List<PartyMemberData> partyMembers = new List<PartyMemberData>();
    
    // Personagem ativo atual
...
// ============================================
// REGISTROS ESPECÍFICOS (MANTIDOS 100%)
// ============================================
...
// ============================================
// HELPER CLASSES (MANTIDAS 100% + NOVO Dictionary)
// ============================================
...
// ============================================
// CLASSES PARA EVENTOS E CONQUISTAS (MANTIDAS 100%)
// ============================================
...
// ============================================
// CLASSE PARA ESTATÍSTICAS DETALHADAS (MANTIDA 100%)
// ============================================
